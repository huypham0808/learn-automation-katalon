...
"Step 2: Login with locked out user"
WebUI.setText(txtUserName, lockedUsername)
WebUI.setText(txtPassword, lockedPassword)
WebUI.click(btnLogin)

"Step 3: Verify an error message is displayed: 'Epic sadface: Sorry, this user has been locked out."
def actualLockedValue = WebUI.getText(invalidCredsError)
WebUI.verifyEqual(actualLockedValue, lockedMessage)